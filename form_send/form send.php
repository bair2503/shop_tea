...
?>
    <form method="post" action="">
        ...
        <p>age:<input type="text" name="age" value="<?php echo htmlspecialchars($age);?>" /></p>
        <p>sex:<input type="radio" name="sex" value="1"<?php if ($sex==1) echo " checked"; ?> >male <input type="radio" name="sex" value="2"<?php if ($sex==2) echo " checked"; ?> >female</p>
        <p>education: <select name="edu"><option value="0" <?php if ($edu==0) echo " selected"; ?>>выбирете</option>
                <option value="1" <?php if ($edu==1) echo " selected"; ?>>не оконченное среднее</option>
                <option value="2" <?php if ($edu==2) echo " selected"; ?>>среднее</option>
                <option value="3" <?php if ($edu==3) echo " selected"; ?>>среднее специальное</option>
                <option value="4" <?php if ($edu==4) echo " selected"; ?>>высшее</option>
            </select></p>

        <p><input type="checkbox" name="subscribe"<?php if ($subscribe) echo" checked"; ?>>Подписаться на рассылку</p>
        <p>комментарии <br>
